...
// small: 2 = 2 // doesn't work to go back from number to literal type, since only can do as cast at declaration I think
...
function getSalary(obj: { id: number; name: string }) {
  // return obj.salary // Property 'salary' does not exist on type '{ id: number; name: string; }'.
  return 0
}
